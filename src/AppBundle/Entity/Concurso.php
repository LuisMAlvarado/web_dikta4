...
class Concurso
{
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="Registro", mappedBy="concurso", cascade={"all"})
    ...
    public function validasalario(ExecutionContextInterface $context)
    {
        ...
        //3 de NOVIEMBRE 2017 se retira la validacion , por que se insertan los datos y no genere error al editar el concurso-dictamen
        /**     if ($this->salarioA < 0) {
        ...
        */
        //TERMINA COMENTARIO DE VALIDACION 3NOVIEMBRE 2017
    ...
    public function getRegistrosCompletos()
    {
        ...
        $criteria = Criteria::create()
            ->where(Criteria::expr()->eq('entregoDocs', true));
